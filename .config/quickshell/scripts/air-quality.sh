...
AIRNOW_API_URL="https://www.airnowapi.org/aq/observation/zipCode/current/?format=application/json&zipCode=${AIRNOW_API_ZIPCODE}&API_KEY=${AIRNOW_API_KEY}"

AIRNOW_API_RESPONSE=$(curl --silent --location "${AIRNOW_API_URL}")
